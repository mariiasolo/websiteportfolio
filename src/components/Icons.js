...
/* export const InstagramIcon = ({ className, ...rest }) => (
    <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width="2em" height="2em" viewBox="0 0 256 256" role="img" aria-labelledby="instagram-icon">
...
export const InstagramIcon = ({className, ...rest}) => (
  ...
  <path fill-rule="evenodd" d="M3.464.639h.752c.536.001.66.006.944.019.34.015.573.069.777.149a1.569 1.569 0 0 1 .567.369 1.569 1.569 0 0 1 .369.567c.079.204.134.436.149.777.015.33.019.443.019 1.235v.169c0 .792-.004.906-.019 1.235a2.362 2.362 0 0 1-.149.777 1.569 1.569 0 0 1-.369.567 1.569 1.569 0 0 1-.567.369 2.331 2.331 0 0 1-.777.149c-.33.015-.443.019-1.235.019h-.169c-.792 0-.906-.004-1.235-.019a2.362 2.362 0 0 1-.777-.149 1.569 1.569 0 0 1-.567-.369 1.569 1.569 0 0 1-.369-.567 2.331 2.331 0 0 1-.149-.777 16.665 16.665 0 0 1-.019-.944v-.751c.001-.536.006-.66.019-.944.015-.34.069-.573.149-.777a1.569 1.569 0 0 1 .369-.567 1.569 1.569 0 0 1 .567-.368c.204-.079.436-.134.777-.149A16.665 16.665 0 0 1 3.465.64h.751Zm.61.576h-.47c-.643.001-.755.005-1.058.018a1.759 1.759 0 0 0-.594.11.994.994 0 0 0-.368.24.991.991 0 0 0-.239.368 1.779 1.779 0 0 0-.11.594 17.749 17.749 0 0 0-.018 1.058v.47c.001.643.005.755.018 1.058.014.312.066.481.11.594a.994.994 0 0 0 .24.368.993.993 0 0 0 .368.239c.112.044.282.096.594.11.337.015.439.018 1.293.018s.956-.003 1.293-.018c.312-.014.482-.066.594-.11a.991.991 0 0 0 .368-.239.991.991 0 0 0 .239-.368c.044-.112.096-.282.11-.594.015-.337.018-.439.018-1.293s-.003-.956-.018-1.293a1.759 1.759 0 0 0-.11-.594.991.991 0 0 0-.239-.368.991.991 0 0 0-.368-.239 1.779 1.779 0 0 0-.594-.11 17.749 17.749 0 0 0-1.058-.018ZM3.84 2.239a1.6 1.6 0 1 1 0 3.201 1.6 1.6 0 0 1 0-3.201Zm0 .561a1.039 1.039 0 1 0 0 2.077 1.039 1.039 0 0 0 0-2.077Zm1.734-1.095a.4.4 0 1 1 0 .8.4.4 0 0 1 0-.8Z"/>
</svg>
);
