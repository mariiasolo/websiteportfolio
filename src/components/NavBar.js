    ...
    dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
       ...
       <div className='w-full flex justify-between items-center lg:hidden'>
            ...
            <nav className='flex items-center justify-center flex-wrap'>
                <motion.a href="https://www.instagram.com/mmmariiasolo" target={"_blank"}
                whileHover={{y:-2}}
                whileTap={{scale: 0.9}}
                className='w-6 mr-3'>
                    <InstagramIcon />
                </motion.a>
                <motion.a href="https://github.com/mariiasolo" target={"_blank"}
                className='w-6 mx-3'
                whileHover={{y:-2}}
                whileTap={{scale: 0.9}}>
                    <GithubIcon />
                </motion.a>
                <motion.a href="https://www.linkedin.com/in/mariia-solo-260190ms/" target={"_blank"}
                className='w-6 ml-3'
                whileHover={{y:-2}}
                whileTap={{scale: 0.9}}>
                    <LinkedInIcon />
            ...
            className={`ml-4 flex items-center justify-center rounded-full p-1 w-6 h-6
        ...
        bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
            ...
            <nav className='flex items-center flex-col justify-center'>
                ...
                {/* <CustomLink href="/articles" title="Articles" className='ml-4' toggle={handleClick} /> */}
            </nav>
